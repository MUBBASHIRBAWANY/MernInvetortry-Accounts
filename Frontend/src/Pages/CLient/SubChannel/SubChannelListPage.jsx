...
import SubChannelList from "../../../Components/Client/SubChannel/SubChannelList"


const SubChannelListPage = () => {
  return (
    <>
     <div>
        <Link to='/SubChannelAdd'>
...
export default SubChannelListPage