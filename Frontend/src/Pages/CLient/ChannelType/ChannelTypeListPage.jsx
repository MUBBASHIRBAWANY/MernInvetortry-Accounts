...
import ChanneTypelList from "../../../Components/Client/ChannelType/ChannelTypeList"


const ChannelTypeListPage = () => {
  return (
    <>
      <div>
        <Link to='/ChannelTypeAdd'>
...
export default ChannelTypeListPage