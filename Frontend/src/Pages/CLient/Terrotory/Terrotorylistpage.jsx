...
import TerrotoryList from '../../../Components/Client/Terrotory/TerrotoryList'
import { Link } from 'react-router-dom'

const Terrotorylistpage = () => {
  return (
    <>
      <div>
        <Link to='/TerrotoryAdd'>
...
export default Terrotorylistpage