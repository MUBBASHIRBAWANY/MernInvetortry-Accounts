...
console.log(Channel)
    const Values = data.map((item, index) => ({
      SubChanneName: item.SubChannelName,
    }));
    console.log(Values)

    try {
      const res = await createDataFunction("/SubChannel/PushBulkData", Values)
...
export default BulkSubChannelAdd