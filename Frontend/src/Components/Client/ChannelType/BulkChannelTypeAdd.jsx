...
const BulkChannelTypeAdd = () => {
  ...
  const onSubmit = async () => {
    ...
    const Values = data.map((item, index) => ({
      ChanneTypeName: item.ChannelTypeName,
    }));
   console.log(Values)

    try {
      const res = await createDataFunction("/chanelType/PushBulkData", Values)
...
export default BulkChannelTypeAdd