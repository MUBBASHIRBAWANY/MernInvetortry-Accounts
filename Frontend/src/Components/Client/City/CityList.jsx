...
const CityList = () => {
  ...
  const getData = async () => {
    try {
      const data = await getDataFundtion("/City")
  ...
  const handleConfirmDelete = async () => {
    ...
    deleteDataFunction(`/City/deleteCity/${selectedId}`)

  };
  const columns = [
    { field: 'code', headerName: 'City Code', width: 250, },
    { field: 'CityName', headerName: 'City', width: 450, },
