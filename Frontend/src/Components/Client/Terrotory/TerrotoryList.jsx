...
const TerrotoryList = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    deleteDataFunction(`Terrotory/deleteTerrotory/${selectedId}`)
  }


  const columns = [
    { field: 'code', headerName: 'Terrotory Code', width: 250, },
    { field: 'TerrotoryName', headerName: 'Terrotory Name', width: 250, },
    {
      field: 'actions',
      type: 'actions',
      headerName: 'Actions',
