...
import { validateArray } from '../Global/CheckUndefind';
import { createDataFunction } from '../../Api/CRUD Functions';

const BulkOderBookerAdd = () => {
  ...
  const onSubmit = async () => {
    ...
    try {
      const arrysValid = validateArray(Values)
      try {
        const res = await createDataFunction(`OrderBooker/PushBulkData`, Values)
...
export default BulkOderBookerAdd